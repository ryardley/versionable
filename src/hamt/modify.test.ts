...
describe("modify", () => {
  it("should update entry in single map", () => {
    ...
    const h1 = hamt.modify((x: any) => x * 2, "a", h);
  ...
  it("should insert into empty map", () => {
    const h = hamt.empty.modify("a", (_: any) => 10);
  ...
  it("should insert if no value in map matches", () => {
    ...
    const h1 = hamt.modify((_: any) => 10, "c", h);
